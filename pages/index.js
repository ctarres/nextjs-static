...
export default class extends React.Component {
  render() {
    return (
      <Layout>
        <h1 className="title title--effect fade-in one">¡Hola!</h1>
        <h2 className="subtitle fade-in two">Im a front-end developer, currently working at Ymbra as a <strong>Drupal</strong> developer. Feel free to contact me</h2>
        <div className="fade-in three">
          <p><a href="" className="know-more animated-arrow">
